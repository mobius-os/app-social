...
async def _resolve_invitees(address: str) -> InviteRecipient:
  ...
  account_hosts = await resolve_handle_hosts(raw)
...
async def create_invite(
  ...
  if body.address:
    ...
    recipient = await _resolve_invitees(body.address)
